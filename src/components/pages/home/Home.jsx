...
const questions = [
    {
        question: "למה לבוא דווקא אלי?",
        answer: "אני אשת מקצוע בעולם הטיפולי, בעלת ניסיון רב בעבודה עם ילדים ובני נוער. רכשתי כלים שונים מעולמות החינוך, הרכיבה הטיפולית והחיבור בין ילדים ונערים לעולם בעלי החיים. בנוסף, אני עובדת כמטפלת NLP ומנוסה בשיח רגשי ובעבודה המותאמת באופן פרטני לכל ילד וילדה, נער ונערה. הסדנה דוגלת ביצירת שינוי חברתי - דרך עבודה על מיומנויות חברתיות ולמידת תקשורת בריאה ונכונה."
    },
    {
    ...
    },
    {
        ...
        answer: "בסדנה נלמד כלים מעולמות ה-NLP והחשיבה החיובית לתקשורת חברתית, יצירת שיחה עם אנשים חדשים, גיבוש עמדה אישית, הבנת החוזקות והכוחות שלנו ושימוש בהם, איך לתפוס תשומת לב בזמן שיחה."
    },
    {
        question: "לילד/ה שלי יש קושי להשתלב חברתית, האם הסדנה יכולה להתאים לו/ה?",
    ...
    return (
        <div className={style.homeContainer}>
            ...
            <section className={style.oneSection}>
                <Text textsArr={[
                    `הסדנאות שלי מועברות בצורה חווייתית ומהנה, דרך משחק, שיח פתוח ומאפשר ותרגול סימולציות מחיי היומיום שלהם. הן מספקות לילדים ובני הנוער הכוונה וכלים ליצירת קשרים חברתיים בריאים ולחיזוק הדימוי העצמי החברתי שלהם. חלק מהסדנאות מועברות בשילוב טיפול באמצעות סוסים.`,
                    `לאורך השנים בעבודתי עם ילדים ובני נוער, מצאתי כי הם עלולים להיות חשופים לפגיעות שונות בבית הספר ובחברה. בעקבות כך הם פחות נוכחים במפגשים חברתיים, מעדיפים לבלות את מרבית זמנם מול המסך בבית, ומתקשים לייצר חברויות יציבות ובריאות עם סביבתם.`,
                    `מסיבה זו פיתחתי סדנאות שיעצימו אותם ויתנו להם כלים וטכניקות מעולם ה-NLP להתמודדות נכונה יותר בחיי היום יום.`,
                    `מטרת הסדנאות הינה לאפשר שיח עמוק בגובה העיניים, לעודד חשיבה יצירתית ואמיצה, לחזק את הביטחון העצמי, להקנות כלים להתמודדות עם קונפליקטים בכיתה ועם סיטואציות חברתיות מורכבות. בתקופת גיל ההתבגרות הילדים ובני הנוער מגבשים את זהותם ולכן חשוב במיוחד לפתח אצלם את המיומנות להקשיב לקולם הפנימי.`
                ]}>
                </Text>
            </section>
            <Sliders />
            ...
            <section className={style.secondSection}>
                ...
                <div className={style.flexBox}>
                    ...
                    <div className={`${style.box} ${style.turquoise}`}>
                        ...
                        <Text textsArr={[
                            `סדנה מעמיקה לאורך 10 מפגשים, בה הילדים ובני הנוער ילמדו שיטות ליצירת כימיה וחיבור עם סביבתם דרך שפת הגוף, משחקים חברתיים, מעגלי שיחה, קלפים טיפוליים וסימולציות של סיטואציות חברתיות נפוצות.`
                        ]} />
                    </div>
                    ...
                    <div className={`${style.box} ${style.purple}`}>
                        ...
                        <Text textsArr={[
                            `תקשורת קבוצתית ובין אישית ברמה הגבוהה ביותר. 5 מפגשים באורך 5 שעות כל אחד!`,
                            `הסדנה תתקיים בחווה טיפולית, בה הילדים ובני הנוער יחוו רכיבה על סוסים שתעצים את הביטחון העצמי שלהם`,
